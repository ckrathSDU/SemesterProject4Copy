...
public interface IEmulatorService {
    ...
    @RequestWrapper(localName = "PickItem", targetNamespace = "http://tempuri.org/", className = "dk.sdu.mmmi.warehouse.SOAPMethods.PickItem")
    @ResponseWrapper(localName = "PickItemResponse", targetNamespace = "http://tempuri.org/", className = "dk.sdu.mmmi.warehouse.SOAPMethods.PickItemResponse")
    ...
    @RequestWrapper(localName = "InsertItem", targetNamespace = "http://tempuri.org/", className = "dk.sdu.mmmi.warehouse.SOAPMethods.InsertItem")
    @ResponseWrapper(localName = "InsertItemResponse", targetNamespace = "http://tempuri.org/", className = "dk.sdu.mmmi.warehouse.SOAPMethods.InsertItemResponse")
    ...
    @RequestWrapper(localName = "GetInventory", targetNamespace = "http://tempuri.org/", className = "dk.sdu.mmmi.warehouse.SOAPMethods.GetInventory")
    @ResponseWrapper(localName = "GetInventoryResponse", targetNamespace = "http://tempuri.org/", className = "dk.sdu.mmmi.warehouse.SOAPMethods.GetInventoryResponse")
